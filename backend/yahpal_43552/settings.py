"""
Django settings for yahpal_43552 project.
...
ROOT_URLCONF = 'yahpal_43552.urls'
...
WSGI_APPLICATION = 'yahpal_43552.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "yahpal_43552 API",
    "DESCRIPTION": "API documentation for yahpal_43552 App",
    "VERSION": "v1",
}
